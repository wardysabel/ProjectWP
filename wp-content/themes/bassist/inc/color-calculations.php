 ...
 */
function bassist_hex2rgb( $color ) {
 ...
 */
function bassist_relative_luminance( $color ) {
	// Convert hex string to rgb array.
	$rgb = bassist_hex2rgb( $color );
 ...
 */
function bassist_contrast_ratio( $color1, $color2 ) {
	// Calculate relative luminance of each color.

	$l1 = bassist_relative_luminance( $color1 );
	$l2 = bassist_relative_luminance( $color2 );
