...
<footer class="container-fluid no-left-padding no-right-padding footer-main footer-section1 <?php echo esc_attr( $footer_color_mode ); ?>">
    ...
    */
    ...
    <div class="copyright">
        ...
        $footer_copyright_text = get_theme_mod( 'wishful_blog_footer_copyright_text' );
        ...
        if( has_filter( 'pro_blog_copyright_text' ) ) {
            ...
            if( !empty( $footer_copyright_text ) ) {
                ...
                printf( esc_html__( '%1$s %2$s by %3$s','wishful-blog' ), $footer_copyright_text, get_bloginfo( 'name' ), '<a href="'. esc_url( 'https://wishfulthemes.com' ) . '">' . esc_html__( 'Wishfulthemes', 'wishful-blog' ) . '</a>' );
