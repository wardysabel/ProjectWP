 ...
 * @since 0.0.1
 */
function canuck_add_page_custom_meta_box() {
	add_meta_box(
		'canuck_page_custom_meta_box',
		__( 'Canuck Page Options', 'canuck' ),
		'canuck_show_page_custom_meta_box',
		'page',
		'normal',
		'high'
	);
}
add_action( 'add_meta_boxes', 'canuck_add_page_custom_meta_box' );
 ...
 * @since 0.0.1
 */
function canuck_show_page_custom_meta_box() {
	global $post;
	$page_template = basename( get_page_template() );
	// Initial notes.
	echo '<span>' . wp_kses_post( __( 'If you are using a Portfolio template, or a Feature template, select the template and <strong>Save Draft</strong> to see more options.', 'canuck' ) ) . '</span>';
	echo '<span><br/>' . esc_html__( 'Also note that the static home page, "Template: Home Page" does not use these options.', 'canuck' ) . '</span>';
	// Use nonce for verification.
	wp_nonce_field( basename( __FILE__ ), 'canuck_page_meta_box_nonce' );
	// **************** Page Layout Option ****************************************************.
	$page_layout = esc_html( get_post_meta( $post->ID, 'canuck_metabox_page_layout', true ) );
	?>
	<p>
		<span style="clear:both;width:200px;float:left;" class="page-meta-layout"><?php esc_html_e( 'Page Layout Options', 'canuck' ); ?></span>
		<select name="page_layout" id="page-layout-id">
			<option<?php selected( 'right_sidebar' === $page_layout ); ?> value="right_sidebar"><?php esc_html_e( 'Right Sidebar', 'canuck' ); ?></option>
			<option<?php selected( 'left_sidebar' === $page_layout ); ?> value="left_sidebar"><?php esc_html_e( 'Left Sidebar', 'canuck' ); ?></option>
			<option<?php selected( 'both_sidebars' === $page_layout ); ?> value="both_sidebars"><?php esc_html_e( 'Both Sidebars', 'canuck' ); ?></option>
			<option<?php selected( 'fullwidth' === $page_layout ); ?> value="fullwidth"><?php esc_html_e( 'Full Width', 'canuck' ); ?></option>
		</select>
	</p>
	<?php
	// **************** Page Title Option ****************************************************.
	$exclude_title = ( '' === get_post_meta( $post->ID, 'canuck_metabox_title', true ) ? false : true );
	?>
	<p>
		<span style="clear:both;width:200px;float:left;" class="exclude-page-title"><?php esc_html_e( 'Exclude Page Title', 'canuck' ); ?></span>
		<input type="checkbox" name="exclude_page_title" id="exclude_page-title-id" <?php checked( $exclude_title, true ); ?>>
	</p>
	<?php
	// **************** Sidebar A Option ****************************************************
	$sidebar_a = esc_html( get_post_meta( $post->ID, 'canuck_metabox_sidebar_a', true ) );
	?>
	<p>
		<span style="clear:both;width:200px;float:left;" class="page-meta-sidebar-a"><?php esc_html_e( 'Sidebar A Options', 'canuck' ); ?></span>
		<select name="sidebar_a" id="sidebar-a-id">
			<option<?php selected( 'default-a' === $sidebar_a ); ?> value="default-a"><?php esc_html_e( 'Default Sidebar A', 'canuck' ); ?></option>
			<option<?php selected( 'default-b' === $sidebar_a ); ?> value="default-b"><?php esc_html_e( 'Default Sidebar B', 'canuck' ); ?></option>
			<option<?php selected( 'blog-a' === $sidebar_a ); ?> value="blog-a"><?php esc_html_e( 'Blog Sidebar A', 'canuck' ); ?></option>
			<option<?php selected( 'blog-b' === $sidebar_a ); ?> value="blog-b"><?php esc_html_e( 'Blog Sidebar B', 'canuck' ); ?></option>
			<option<?php selected( 'about-a' === $sidebar_a ); ?> value="about-a"><?php esc_html_e( 'About Sidebar A', 'canuck' ); ?></option>
			<option<?php selected( 'about-b' === $sidebar_a ); ?> value="about-b"><?php esc_html_e( 'About Sidebar B', 'canuck' ); ?></option>
			<option<?php selected( 'contact-a' === $sidebar_a ); ?> value="contact-a"><?php esc_html_e( 'Contact Sidebar A', 'canuck' ); ?></option>
			<option<?php selected( 'contact-b' === $sidebar_a ); ?> value="contact-b"><?php esc_html_e( 'Contact Sidebar B', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-1' === $sidebar_a ); ?> value="sidebar-1"><?php esc_html_e( 'Extra Sidebar 1', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-2' === $sidebar_a ); ?> value="sidebar-2"><?php esc_html_e( 'Extra Sidebar 2', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-3' === $sidebar_a ); ?> value="sidebar-3"><?php esc_html_e( 'Extra Sidebar 3', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-4' === $sidebar_a ); ?> value="sidebar-4"><?php esc_html_e( 'Extra Sidebar 4', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-5' === $sidebar_a ); ?> value="sidebar-5"><?php esc_html_e( 'Extra Sidebar 5', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-6' === $sidebar_a ); ?> value="sidebar-6"><?php esc_html_e( 'Extra Sidebar 6', 'canuck' ); ?></option>
		</select>
	</p>
	<?php
	// **************** Sidebar B Option ****************************************************.
	$sidebar_b = esc_html( get_post_meta( $post->ID, 'canuck_metabox_sidebar_b', true ) );
	?>
	<p>
		<span style="clear:both;width:200px;float:left;" class="page-meta-sidebar-b"><?php esc_html_e( 'Sidebar B Options', 'canuck' ); ?></span>
		<select name="sidebar_b" id="sidebar-b-id">
			<option<?php selected( 'default-b' === $sidebar_b ); ?> value="default-b"><?php esc_html_e( 'Default Sidebar B', 'canuck' ); ?></option>
			<option<?php selected( 'default-a' === $sidebar_b ); ?> value="default-a"><?php esc_html_e( 'Default Sidebar A', 'canuck' ); ?></option>
			<option<?php selected( 'blog-a' === $sidebar_b ); ?> value="blog-a"><?php esc_html_e( 'Blog Sidebar A', 'canuck' ); ?></option>
			<option<?php selected( 'blog-b' === $sidebar_b ); ?> value="blog-b"><?php esc_html_e( 'Blog Sidebar B', 'canuck' ); ?></option>
			<option<?php selected( 'about-a' === $sidebar_b ); ?> value="about-a"><?php esc_html_e( 'About Sidebar A', 'canuck' ); ?></option>
			<option<?php selected( 'about-b' === $sidebar_b ); ?> value="about-b"><?php esc_html_e( 'About Sidebar B', 'canuck' ); ?></option>
			<option<?php selected( 'contact-a' === $sidebar_b ); ?> value="contact-a"><?php esc_html_e( 'Contact Sidebar A', 'canuck' ); ?></option>
			<option<?php selected( 'contact-b' === $sidebar_b ); ?> value="contact-b"><?php esc_html_e( 'Contact Sidebar B', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-1' === $sidebar_b ); ?> value="sidebar-1"><?php esc_html_e( 'Extra Sidebar 1', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-2' === $sidebar_b ); ?> value="sidebar-2"><?php esc_html_e( 'Extra Sidebar 2', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-3' === $sidebar_b ); ?> value="sidebar-3"><?php esc_html_e( 'Extra Sidebar 3', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-4' === $sidebar_b ); ?> value="sidebar-4"><?php esc_html_e( 'Extra Sidebar 4', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-5' === $sidebar_b ); ?> value="sidebar-5"><?php esc_html_e( 'Extra Sidebar 5', 'canuck' ); ?></option>
			<option<?php selected( 'sidebar-6' === $sidebar_b ); ?> value="sidebar-6"><?php esc_html_e( 'Extra Sidebar 6', 'canuck' ); ?></option>
		</select>
	</p>
	<?php
	...
	if ( 'template-feature.php' === $page_template ) {
		?>
		<span><br/><?php esc_html_e( 'Additional options available when Template is set to Feature Template', 'canuck' ); ?></span>
		<?php
		...
		<?php
		// **************** Feature Slider Type ****************************************************
		$feature_type = esc_html( get_post_meta( $post->ID, 'canuck_metabox_feature_type', true ) );
		?>
		<p>
			<span style="clear:both;width:200px;float:left;" class="feature-type"><?php esc_html_e( 'Feature Type', 'canuck' ); ?></span>
			<select name="feature_type" id="feature-type-id">
				<option<?php selected( 'button-nav-15to1' === $feature_type ); ?> value="button-nav-15to1"><?php esc_html_e( 'Button navigation', 'canuck' ); ?></option>
				<option<?php selected( 'carousel-top' === $feature_type ); ?> value="carousel-top"><?php esc_html_e( 'Carousel navigation on top', 'canuck' ); ?></option>
				<option<?php selected( 'carousel-bottom' === $feature_type ); ?> value="carousel-bottom"><?php esc_html_e( 'Carousel navigation on bottom', 'canuck' ); ?></option>
			</select>
		</p>
		<?php
	}// End if().
	...
	if ( 'template-portfolio.php' === $page_template ) {
		?>
		<p><strong><?php esc_html_e( 'Additional options available when Template is set to Portfolio Template', 'canuck' ); ?></strong></p>
		<span><strong><?php esc_html_e( 'Posts', 'canuck' ); ?> - </strong><?php esc_html_e( 'Before setting up a Portfolio Page you will need to have set up posts with a feature image of a specific category.', 'canuck' ); ?></span>
		<span> <?php esc_html_e( 'When you set up your posts and insert your featured images, pay attention to the image links in the Canuck Post Options.', 'canuck' ); ?></span>
		<span><br/><strong><?php esc_html_e( 'Portfolio Category - ', 'canuck' ); ?></strong><?php esc_html_e( 'Select the category you used from the dropdown selector below.', 'canuck' ); ?></span>
		<span><br/><strong><?php esc_html_e( 'Portfolio Type - ', 'canuck' ); ?></strong><?php esc_html_e( 'Select the type of portfolio you want from the dropdown selector below.', 'canuck' ); ?></span>
		<span><br/><strong><?php esc_html_e( 'Post Title and Content - ', 'canuck' ); ?></strong><?php esc_html_e( 'Can be used for the Classic Portfolio styles only.', 'canuck' ); ?></span>
		<span><br/><strong><?php esc_html_e( 'Image Caption and Description - ', 'canuck' ); ?></strong><?php esc_html_e( 'You set these up in the media editor for your image.', 'canuck' ); ?></span>
		<span> <?php esc_html_e( 'They can be optionally used in the Classic Portfolio styles and are used in all the Grid Portfolio styles.', 'canuck' ); ?></span>
		<span> <?php esc_html_e( 'The idea is to use image title and description as a short introduction to a more extensive post which you would then link to.', 'canuck' ); ?></span>
		<span><br/><strong><?php esc_html_e( 'Tip 1 - ', 'canuck' ); ?></strong><?php esc_html_e( 'Keep layouts to less than 4 columns including sidebars, the exception being the Grid 5 columns in the fullwidth layout.', 'canuck' ); ?></span>
		<span><br/><strong><?php esc_html_e( 'Tip 2 - ', 'canuck' ); ?></strong><?php esc_html_e( 'Make your title and descriptions shorter when you have more columns on the page.', 'canuck' ); ?></span>
		<?php
		// **************** Portfolio Category ****************************************************.
		...
		<?php
		// **************** Portfolio Columns ****************************************************.
		$portfolio_type = esc_html( get_post_meta( $post->ID, 'canuck_portfolio_type', true ) );
		?>
		<p>
			<span style="clear:both;width:200px;float:left;" class="portfolio-type"><?php esc_html_e( 'Portfolio Type', 'canuck' ); ?></span>
			<select name="portfolio_type" id="portfolio-type-id">
				<option<?php selected( 'classic1' === $portfolio_type ); ?> value="classic1"><?php esc_html_e( 'Classic 1 column', 'canuck' ); ?></option>
				<option<?php selected( 'classic2' === $portfolio_type ); ?> value="classic2"><?php esc_html_e( 'Classic 2 columns', 'canuck' ); ?></option>
				<option<?php selected( 'classic3' === $portfolio_type ); ?> value="classic3"><?php esc_html_e( 'Classic 3 columns', 'canuck' ); ?></option>
				<option<?php selected( 'classic4' === $portfolio_type ); ?> value="classic4"><?php esc_html_e( 'Classic 4 columns', 'canuck' ); ?></option>
				<option<?php selected( 'fullwidth' === $portfolio_type ); ?> value="fullwidth"><?php esc_html_e( 'fullwidth', 'canuck' ); ?></option>
				<option<?php selected( 'grid2' === $portfolio_type ); ?> value="grid2"><?php esc_html_e( 'Grid 2 columns', 'canuck' ); ?></option>
				<option<?php selected( 'grid3' === $portfolio_type ); ?> value="grid3"><?php esc_html_e( 'Grid 3 columns', 'canuck' ); ?></option>
				<option<?php selected( 'grid4' === $portfolio_type ); ?> value="grid4"><?php esc_html_e( 'Grid 4 columns', 'canuck' ); ?></option>
				<option<?php selected( 'grid5' === $portfolio_type ); ?> value="grid5"><?php esc_html_e( 'Grid 5 columns', 'canuck' ); ?></option>
				<option<?php selected( 'masonry3' === $portfolio_type ); ?> value="masonry3"><?php esc_html_e( 'Masonry 3 columns', 'canuck' ); ?></option>
			</select>
		</p>
		<?php
		// **************** Portfolio Include Post Title ****************************************************
		$portfolio_post_title = get_post_meta( $post->ID, 'canuck_metabox_include_post_content_title', true ) ? true : false;
		?>
		<p>
			<span style="clear:both;width:200px;float:left;" class="include-post-title"><?php esc_html_e( 'Include Post Title', 'canuck' ); ?></span>
		...
		$portfolio_image_caption = get_post_meta( $post->ID, 'canuck_metabox_include_image_caption', true ) ? true : false;
		?>
		<p>
			<span style="clear:both;width:200px;float:left;" class="include-image-caption"><?php esc_html_e( 'Include Feature Image Caption', 'canuck' ); ?></span>
		...
		$portfolio_image_desc = get_post_meta( $post->ID, 'canuck_metabox_include_image_description', true ) ? true : false;
		?>
		<p>
			<span style="clear:both;width:200px;float:left;" class="include-image-desc"><?php esc_html_e( 'Include Feature Image Description', 'canuck' ); ?></span>
 ...
 */
function canuck_save_page_custom_meta( $post_id ) {
	global $post;
	$page_template = basename( get_page_template() );
	// Verify nonce.
	...
	if ( '' !== $page_layout_new && '' === $page_layout_old && $default !== $page_layout_new ) {
		...
		update_post_meta( $post_id, 'canuck_metabox_page_layout', $page_layout_new );
	} elseif ( '' === $page_layout_new || $default === $page_layout_new && '' !== $page_layout_old ) {
		// Delete meta if default is used.
		delete_post_meta( $post_id, 'canuck_metabox_page_layout' );
	}
	// Include post title.
	...
	if ( true === $exclude_title_new && false === $exclude_title_old ) {
		...
		delete_post_meta( $post_id, 'canuck_metabox_title' );
	}
	// Sidebar a option.
	...
	if ( '' !== $sidebar_a_new && '' === $sidebar_a_old && $default !== $sidebar_a_new ) {
		...
		// If the new meta value does not match the old value, update it.
		update_post_meta( $post_id, 'canuck_metabox_sidebar_a', $sidebar_a_new );
	} elseif ( '' === $sidebar_a_new || $default === $sidebar_a_new && '' !== $sidebar_a_old ) {
		// Delete meta if default is used.
		delete_post_meta( $post_id, 'canuck_metabox_sidebar_a' );
	}
	// Sidebar b option.
	...
	if ( '' !== $sidebar_b_new && '' === $sidebar_b_old && $default !== $sidebar_b_new ) {
		...
		// If the new meta value does not match the old value, update it.
		update_post_meta( $post_id, 'canuck_metabox_sidebar_b', $sidebar_b_new );
	} elseif ( '' === $sidebar_b_new || $default === $sidebar_b_new && '' !== $sidebar_b_old ) {
		// Delete meta if default is used.
		delete_post_meta( $post_id, 'canuck_metabox_sidebar_b' );
	}
	...
	if ( 'template-feature.php' === $page_template ) {
		...
		if ( '' !== $feature_category_new && '' === $feature_category_old ) {
			...
			// If the new meta value does not match the old value, update it.
			update_post_meta( $post_id, 'canuck_metabox_feature_category', $feature_category_new );
		} elseif ( '' === $feature_category_new && '' !== $feature_category_old ) {
			// If there is no new meta value but an old value exists, delete it.
			delete_post_meta( $post_id, 'canuck_metabox_feature_category' );
		}
		// Feature slider type.
		...
		if ( '' !== $feature_type_new && '' === $feature_type_old && $default !== $feature_type_new ) {
			...
			// If the new meta value does not match the old value, update it.
			update_post_meta( $post_id, 'canuck_metabox_feature_type', $feature_type_new );
		} elseif ( '' === $feature_type_new || $default === $feature_type_new && $feature_type_old ) {
			// If there is no new meta value but an old value exists, delete it.
			delete_post_meta( $post_id, 'canuck_metabox_feature_type' );
		}
	}
	// Additional options available when Template = Portfolio Template.
	if ( 'template-portfolio.php' === $page_template ) {
		...
		if ( '' !== $portfolio_category_new && '' === $portfolio_category_old ) {
			...
			// If the new meta value does not match the old value, update it.
			update_post_meta( $post_id, 'canuck_portfolio_category', $portfolio_category_new );
		} elseif ( '' === $portfolio_category_new && '' !== $portfolio_category_old ) {
			// If there is no new meta value but an old value exists, delete it.
			delete_post_meta( $post_id, 'canuck_portfolio_category' );
		}
		// Portfolio columns.
		...
		if ( '' !== $portfolio_type_new && '' === $portfolio_type_old && $default !== $portfolio_type_new ) {
			...
			// If the new meta value does not match the old value, update it.
			update_post_meta( $post_id, 'canuck_portfolio_type', $portfolio_type_new );
		} elseif ( '' === $portfolio_type_new || $default === $portfolio_type_new && '' !== $portfolio_type_old ) {
			// If there is no new meta value but an old value exists, delete it.
			delete_post_meta( $post_id, 'canuck_portfolio_type' );
		}
		// Include post title.
		...
		if ( true === $portfolio_post_title_new && false === $portfolio_post_title_old ) {
			...
			// If there is no new meta value but an old value exists, delete it.
			delete_post_meta( $post_id, 'canuck_metabox_include_post_content_title' );
		}
		...
		if ( true === $portfolio_post_content_new && false === $portfolio_post_content_old ) {
			...
			// If there is no new meta value but an old value exists, delete it.
			delete_post_meta( $post_id, 'canuck_metabox_include_post_content' );
		}
		...
		if ( true === $portfolio_image_caption_new && false === $portfolio_image_caption_old ) {
			...
			// If there is no new meta value but an old value exists, delete it.
			delete_post_meta( $post_id, 'canuck_metabox_include_image_caption' );
		}
		...
		if ( true === $portfolio_image_desc_new && false === $portfolio_image_desc_old ) {
			...
			// If there is no new meta value but an old value exists, delete it.
			delete_post_meta( $post_id, 'canuck_metabox_include_image_description' );
		}
	}// End if().
}
add_action( 'save_post', 'canuck_save_page_custom_meta' );
...
function canuck_add_post_custom_meta_box() {
	add_meta_box(
		...
		__( 'Canuck Post Options', 'canuck' ),
		'canuck_show_post_custom_meta_box',
		'post',
		'normal',
		'high'
	);
}
add_action( 'add_meta_boxes', 'canuck_add_post_custom_meta_box' );
 ...
 * @since 0.0.1
 */
function canuck_show_post_custom_meta_box() {
	global $post;
	// Use nonce for verification.
	wp_nonce_field( basename( __FILE__ ), 'canuck_post_meta_box_nonce' );
	?>
	<span>
		<br/>
		<?php esc_html_e( 'If using the feature image for a home, blog or feature slider clicking this option will place the the post title in caption strip on the image.', 'canuck' ); ?>
	</span>
	<?php
	...
	<p>
		<span style="clear:both;width:200px;float:left;" class="link-to-title">
			<?php esc_html_e( 'Add post title caption to image', 'canuck' ); ?>
		</span>
		<input type="checkbox" name="include_feature_title" id="include_feature_title_id" <?php checked( $include_feature_title, true ); ?>>
	</p>
	<span>
		<br/>
		<?php esc_html_e( 'Feature images can have no links, link to the post, or provide a custom link.', 'canuck' ); ?>
	</span>
	<?php
	// **************** Include Link to Post ****************************************************
	...
	<p>
		<span style="clear:both;width:200px;float:left;" class="link-to-post">
			<?php esc_html_e( 'Link feature image to this post', 'canuck' ); ?>
		</span>
		<input type="checkbox" name="link_to_post" id="link-to-post-id" <?php checked( $link_to_post, true ); ?>>
	</p>
	<?php
	// **************** Use feature image custom link ****************************************************
	$custom_link = get_post_meta( $post->ID, 'canuck_custom_feature_link', true );
	?>
	<p>
		<span style="clear:both;width:200px;float:left;" class="custom-link">
			<?php esc_html_e( 'Input a custom link', 'canuck' ); ?>
			<br/>
			<?php esc_html_e( 'format: //yourlink.com', 'canuck' ); ?>
		</span>
...
function canuck_save_post_custom_meta( $post_id ) {
	...
	if ( true === $include_feature_title_new && false === $include_feature_title_old ) {
		...
		// If there is no new meta value but an old value exists, delete it.
		update_post_meta( $post_id, 'canuck_metabox_include_feature_title', $include_feature_title_new );
	} elseif ( false === $include_feature_title_new || false === $include_feature_title_new && true === $include_feature_title_old ) {
		// If there is no new meta value but an old value exists, delete it.
		delete_post_meta( $post_id, 'canuck_metabox_include_feature_title' );
	}
	// Link to post.
	...
	if ( true === $link_to_post_new && false === $link_to_post_old ) {
		...
		// If there is no new meta value but an old value exists, delete it.
		update_post_meta( $post_id, 'canuck_metabox_link_to_post', $link_to_post_new );
	} elseif ( false === $link_to_post_new || false === $link_to_post_new && true === $link_to_post_old ) {
		// If there is no new meta value but an old value exists, delete it.
		delete_post_meta( $post_id, 'canuck_metabox_link_to_post' );
	}
	// Custom link.
	...
	if ( '' !== $custom_link_new && '' === $custom_link_old ) {
		...
		add_post_meta( $post_id, 'canuck_custom_feature_link', $custom_link_new, true );
			...
			// If the new meta value does not match the old value, update it.
			update_post_meta( $post_id, 'canuck_custom_feature_link', $custom_link_new );
	} elseif ( '' === $custom_link_new && '' !== $custom_link_old ) {
		// If there is no new meta value but an old value exists, delete it.
		delete_post_meta( $post_id, 'canuck_custom_feature_link' );
	}
}
add_action( 'save_post', 'canuck_save_post_custom_meta' );
