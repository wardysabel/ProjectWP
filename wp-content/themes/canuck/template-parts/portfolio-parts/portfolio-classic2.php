<?php
/**
 * Canuck Portfolio Two Column template part
 *
...
if ( 0 !== $category_id && $custom_posts ) {
	...
	?>
	<div class="portfolio-two-column-wrap">
		<?php
		foreach ( $custom_posts as $post ) { // phpcs:ignore
			...
			if ( has_post_thumbnail() ) {
				if ( 0 === $canuck_feature_pic_count || is_int( $canuck_feature_pic_count / 2 ) ) {
					?>
					<div class="portfolio-two-column left-col">
					<?php
				} else {
					?>
					<div class="portfolio-two-column right-col">
					<?php
				}
