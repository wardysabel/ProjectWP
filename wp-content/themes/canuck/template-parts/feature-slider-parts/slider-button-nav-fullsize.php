...
if ( 0 !== $category_id && $custom_posts ) {
	...
	<div class="flexslider-wrapper">
		<img class="button-place-holder" style="width:100%;height:auto;" alt="<?php esc_attr_e( 'placeholder', 'canuck' ); ?>" src="<?php echo get_template_directory_uri() . '/images/placeholder15.png';// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" />
							...
							if ( true === $link_to_post ) {
								...
								<a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute( 'echo=0' ); ?>">
									<img src="<?php echo esc_url( $image_url_medium_large ); ?>"
										srcset="<?php echo $srcset;// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"
										sizes="100vw"
