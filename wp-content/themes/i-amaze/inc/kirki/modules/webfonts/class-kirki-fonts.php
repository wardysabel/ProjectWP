...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'i-amaze' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'i-amaze' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'i-amaze' ),
			'200'       => esc_attr__( 'Light 200', 'i-amaze' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'i-amaze' ),
			'300'       => esc_attr__( 'Book 300', 'i-amaze' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'i-amaze' ),
			'400'       => esc_attr__( 'Normal 400', 'i-amaze' ),
			'regular'   => esc_attr__( 'Normal 400', 'i-amaze' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'i-amaze' ),
			'500'       => esc_attr__( 'Medium 500', 'i-amaze' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'i-amaze' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'i-amaze' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'i-amaze' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'i-amaze' ),
			'700'       => esc_attr__( 'Bold 700', 'i-amaze' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'i-amaze' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'i-amaze' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'i-amaze' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'i-amaze' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'i-amaze' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'i-amaze' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'i-amaze' ),
		);
	}
