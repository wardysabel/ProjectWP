...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'i-amaze' ),
				'change'       => esc_attr__( 'Change image', 'i-amaze' ),
				'default'      => esc_attr__( 'Default', 'i-amaze' ),
				'remove'       => esc_attr__( 'Remove', 'i-amaze' ),
				'placeholder'  => esc_attr__( 'No image selected', 'i-amaze' ),
				'frame_title'  => esc_attr__( 'Select image', 'i-amaze' ),
				'frame_button' => esc_attr__( 'Choose image', 'i-amaze' ),
			)
		);
	}
