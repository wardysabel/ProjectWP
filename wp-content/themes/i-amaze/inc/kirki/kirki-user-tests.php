...
class Kirki_Test_Field {
	...
	public function create_section() {
		Kirki::add_section( sanitize_key( $this->field['type'] ), array(
			'priority' => 10,
			'title'    => sprintf( __( '%s test', 'i-amaze' ), $this->field['type'] ),
		) );
	}
	...
	public function add_filter_fields( $fields ) {
		...
		$args['label']       = sprintf( __( '%s theme_mod via filter', 'i-amaze' ), $args['type'] );
		$args['option_type'] = 'theme_mod';
		$fields[] = $args;

		$args['settings']    = sanitize_key( $this->field['type'] ).'_demo_1';
		$args['label']       = sprintf( __( '%s single option via filter', 'i-amaze' ), $args['type'] );
		$args['option_type'] = 'option';
		$fields[] = $args;

		$args['settings']    = sanitize_key( $this->field['type'] ).'_demo_2';
		$args['option_type'] = 'option';
		$args['label']       = sprintf( __( '%s serialized option via filter', 'i-amaze' ), $args['type'] );
	...
	public function add_fields_via_api() {
		...
		$args['label']       = sprintf( __( '%s theme_mod via API', 'i-amaze' ), $args['type'] );
		$args['option_type'] = 'theme_mod';
		Kirki::add_field( '', $args );

		$args['settings']    = sanitize_key( $this->field['type'] ).'_demo_4';
		$args['label']       = sprintf( __( '%s single option via API', 'i-amaze' ), $args['type'] );
		$args['option_type'] = 'option';
		Kirki::add_field( '', $args );

		$args['settings']    = sanitize_key( $this->field['type'] ).'_demo_5';
		$args['option_type'] = 'option';
		$args['label']       = sprintf( __( '%s serialized option via API', 'i-amaze' ), $args['type'] );
		$args['option_name'] = 'kirki_test';
		Kirki::add_field( '', $args );
...
// multicheck
$multicheck = new Kirki_Test_Field( array( 'type' => 'multicheck', 'default' => array( 'option1' ), 'choices' => array( 'option1' => __( 'Option 1', 'i-amaze' ), 'option2' => __( 'Option 2', 'i-amaze' ), 'option3' => __( 'Option 3', 'i-amaze' ) ) ) );
...
// radio-buttonset
$radio_buttonset = new Kirki_Test_Field( array( 'type' => 'radio-buttonset', 'default' => 'option2', 'choices' => array( 'option1' => __( 'Option 1', 'i-amaze' ), 'option2' => __( 'Option 2', 'i-amaze' ), 'option-3' => __( 'Option 3', 'i-amaze' ) ) ) );
...
// radio
$radio = new Kirki_Test_Field( array( 'type' => 'radio', 'default' => 'option1', 'choices' => array( 'option1' => __( 'Option 1', 'i-amaze' ), 'option2' => __( 'Option 2', 'i-amaze' ), 'option3' => __( 'Option 3', 'i-amaze' ) ) ) );

// select
$select = new Kirki_Test_Field( array( 'type' => 'select', 'default' => 'option2', 'choices' => array( 'option1' => __( 'Option 1', 'i-amaze' ), 'option2' => __( 'Option 2', 'i-amaze' ), 'option3' => __( 'Option 3', 'i-amaze' ) ) ) );

// slider
$slider = new Kirki_Test_Field( array( 'type' => 'slider', 'default' => 0, 'choices' => array( 'min' => -100, 'max' => 100, 'step' => 1 ) ) );

// sortable
$sortable = new Kirki_Test_Field( array( 'type' => 'sortable', 'default' => array( 'option2', 'option1' ), 'choices' => array( 'option1' => __( 'Option 1', 'i-amaze' ), 'option2' => __( 'Option 2', 'i-amaze' ), 'option3' => __( 'Option 3', 'i-amaze' ), 'option4' => __( 'Option 4', 'i-amaze' ) ) ) );

// switch
$switch = new Kirki_Test_Field( array( 'type' => 'switch', 'default' => '1' ) );

// text
$text = new Kirki_Test_Field( array( 'type' => 'text', 'default' => __( 'This is some default text for the text control.', 'i-amaze' ) ) );

// textarea
$textarea = new Kirki_Test_Field( array( 'type' => 'textarea', 'default' => __( 'This is some default text for the textarea control.', 'i-amaze' ) ) );
