...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'i-amaze' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'i-amaze' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'i-amaze' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'i-amaze' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'i-amaze' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'i-amaze' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'i-amaze' ); ?>',
		} );
		#>
		<label>
