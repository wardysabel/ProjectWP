...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected'   => esc_attr__( 'No File Selected', 'i-amaze' ),
				'remove'           => esc_attr__( 'Remove', 'i-amaze' ),
				'default'          => esc_attr__( 'Default', 'i-amaze' ),
				'selectFile'       => esc_attr__( 'Select File', 'i-amaze' ),
				'standardFonts'    => esc_attr__( 'Standard Fonts', 'i-amaze' ),
				'googleFonts'      => esc_attr__( 'Google Fonts', 'i-amaze' ),
				'defaultCSSValues' => esc_attr__( 'Default CSS Values', 'i-amaze' ),
			)
		);
