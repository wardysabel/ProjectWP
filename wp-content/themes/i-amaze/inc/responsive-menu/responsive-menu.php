...
add_action( 'wp_enqueue_scripts', 'iamaze_enqueue_scripts' );

function iamaze_enqueue_scripts() {
	...
	wp_enqueue_script('iamaze-wprmenu', get_template_directory_uri() . '/inc/responsive-menu/js/wprmenu.js', array( 'jquery' ), '2017-03-16', true );	
	...
	wp_localize_script( 'iamaze-wprmenu', 'wprmenu', $wpr_options );
}

add_action('wp_footer', 'iamaze_menu', 100);
function iamaze_menu() {
...
add_action('wp_head', 'iamaze_header_styles');