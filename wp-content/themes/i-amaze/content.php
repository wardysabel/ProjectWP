        ...
        <div class="post-mainpart">    
            ...
            <div class="entry-content">
				...
				<?php
                    ...
                    {
                        the_content( esc_html__( 'Continue reading <span class="meta-nav">&rarr;</span>', 'i-amaze' ) );
                    } else
                    {
						the_excerpt();
                    }
            ...
            <footer class="entry-meta">
                <?php if ( comments_open() && ! is_single() ) : ?>
                    <div class="comments-link">
                        <?php comments_popup_link( '<span class="leave-reply">' . esc_attr__( 'Leave a comment', 'i-amaze' ) . '</span>', esc_attr__( 'One comment so far', 'i-amaze' ), esc_attr__( 'View all % comments', 'i-amaze' ) ); ?>
                    </div><!-- .comments-link -->
