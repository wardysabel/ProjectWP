...
LOCK TABLES `wp_supsystic_tbl_diagrams` WRITE;
/*!40000 ALTER TABLE `wp_supsystic_tbl_diagrams` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_supsystic_tbl_diagrams` ENABLE KEYS */;
UNLOCK TABLES;
