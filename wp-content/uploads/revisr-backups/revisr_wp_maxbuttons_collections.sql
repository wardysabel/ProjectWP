...
LOCK TABLES `wp_maxbuttons_collections` WRITE;
/*!40000 ALTER TABLE `wp_maxbuttons_collections` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_maxbuttons_collections` ENABLE KEYS */;
UNLOCK TABLES;
