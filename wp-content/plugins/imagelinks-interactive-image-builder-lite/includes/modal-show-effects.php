...
<div id="imagelinks-modal-{{ modalData.id }}" class="imagelinks-modal" tabindex="-1">
	<div class="imagelinks-modal-dialog">
		<div class="imagelinks-modal-header">
			...
			<div class="imagelinks-modal-title"><?php _e('Select a show effect', IMAGELINKS_PLUGIN_NAME); ?></div>
		</div>
		...
		<div class="imagelinks-modal-footer">
			<div class="imagelinks-modal-text"><?php _e('Selected effect:', IMAGELINKS_PLUGIN_NAME); ?> <b>{{modalData.selectedClass}}</b></div>
