...
Tags: interactive world map, interactive map, united states map, map, maps, interactive maps, html5 map, svg map, clickable map, html5maps, us map, responsive map
...
The free versions of the maps display the "Map by Fla-shop.com" link as required by the license agreement found [here](https://www.fla-shop.com/free_stuff.php#terms).
...
== Changelog ==
= 1.6.7.2 =
* Berlin and Brandenburg maps are added

= 1.6.7.1 =
* New York City and Zurich maps are added
* Fix for map of Philippines

= 1.6.7.0 =
* Tokyo and Osaka maps are added

= 1.6.6.9 =
* Copenhagen and Geneva maps are added

= 1.6.6.8 =
* Added map of London

= 1.6.6.7 =
* Added a new map, Paris with arrondissements

= 1.6.6.6 =
* Added new maps - Monaco and San Marino

= 1.6.6.5 =
* Added maps of the regions of France - Normandie, Nouvelle-Aquitaine, Occitanie, Pays de la Loire, Provence-Alpes-Côte d'Azur

= 1.6.6.4 =
* Added maps of the regions of France - Corse, Grand Est, Hauts-de-France, Île-de-France

= 1.6.6.3 =
* Added maps of the regions of France - Auvergne-Rhône-Alpes, Bourgogne-Franche-Comté, Bretagne, Center-Val de Loire

= 1.6.6.2 =
* Added new maps - Taiwan, Turkmenistan

= 1.6.6.1 =
* Added new maps - Tajikistan, Yemen

= 1.6.6.0 =
* Minor fixes for the world map

= 1.6.5.9 =
* Added new maps - Saudi Arabia, United Arab Emirates

= 1.6.5.8 =
* Added new maps - Philippines, Qatar

= 1.6.5.7 =
* Bug fixes and improvements

= 1.6.5.6 =
* Added new maps - Oman, Pakistan

= 1.6.5.5 =
* Added new maps - Malaysia, Nepal

= 1.6.5.4 =
* Added new maps - Laos, Lebanon

= 1.6.5.3 =
* Added new maps - Kazakhstan, Kuwait

= 1.6.5.2 =
* Added new maps - Brunei, Jordan

= 1.6.5.1 =
* Added new maps - Canada, Hong Kong

= 1.6.5.0 =
* Added new maps - Switzerland, Turkey

= 1.6.4.9 =
* Added new maps - Montenegro, Norway

= 1.6.4.8 =
* Added new maps - Malta, North Macedonia

= 1.6.4.7 =
* Added new maps - Iraq, Israel

= 1.6.4.6 =
* Added new maps - Indonesia, Iran

= 1.6.4.5 =
* Added new maps - Bosnia and Herzegovina, Georgia

= 1.6.4.4 =
* Added new maps - Liechtenstein, Lithuania

= 1.6.4.3 =
* Added new maps - Cyprus, Finland

= 1.6.4.2 =
* Added new maps - Slovakia, Slovenia

= 1.6.4.1 =
* Added the map of Zimbabwe

= 1.6.4.0 =
* Added new maps - Uganda, Zambia
...
= 1.5.9.9 =
* Added the map of Singapore

= 1.5.9.8 =
* Fixed the work of maps when using Autoptimize plugin.

= 1.5.9.7 =
* The minification of code has been added, which provides better compatibility with WP themes that use the visual page builders.
* Added the map of South Korea.

= 1.5.9.6 =
* Added the map of Vietnam

= 1.5.9.5 =
* Added the map of Japan
* Fixed the representation of several maps at one page
